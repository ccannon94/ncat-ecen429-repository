...
HD_PWD='C:/Users/Chris/Documents/development/ncat-ecen429-repository/Lab8/Lab8Part3/Lab8Part3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_control.tcl

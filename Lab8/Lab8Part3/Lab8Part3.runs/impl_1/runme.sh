...
HD_PWD='C:/Users/Chris/Documents/development/ncat-ecen429-repository/Lab8/Lab8Part3/Lab8Part3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_control.tcl -notrace

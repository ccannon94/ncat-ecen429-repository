...
HD_PWD='C:/Users/Chris/Documents/development/ncat-ecen429-repository/Lab7/Lab7Part1/Lab7Part1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ArithmeticLogicUnit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ArithmeticLogicUnit.tcl -notrace

...
HD_PWD='C:/Users/Chris/Documents/development/ncat-ecen429-repository/Lab7/Lab7Part1/Lab7Part1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ArithmeticLogicUnit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ArithmeticLogicUnit.tcl

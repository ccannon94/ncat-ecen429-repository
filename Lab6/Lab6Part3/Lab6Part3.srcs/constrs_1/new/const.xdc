...
set_property PACKAGE_PIN U16 [get_ports {state[4]}]
set_property PACKAGE_PIN E19 [get_ports {state[3]}]
set_property PACKAGE_PIN U19 [get_ports {state[2]}]
set_property PACKAGE_PIN V19 [get_ports {state[1]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports clock_reset]

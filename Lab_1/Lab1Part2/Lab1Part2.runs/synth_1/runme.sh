...
HD_PWD='/home/chris/Documents/development/ncat-ecen429-repository/Lab_1/Lab1Part2/Lab1Part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1part2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1part2.tcl

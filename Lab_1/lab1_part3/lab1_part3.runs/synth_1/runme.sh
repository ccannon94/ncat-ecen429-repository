...
HD_PWD='/home/chris/Documents/development/ncat-ecen429-repository/Lab_1/lab1_part3/lab1_part3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1part3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1part3.tcl

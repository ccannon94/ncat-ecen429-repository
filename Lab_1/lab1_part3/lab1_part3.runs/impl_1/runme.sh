...
HD_PWD='/home/chris/Documents/development/ncat-ecen429-repository/Lab_1/lab1_part3/lab1_part3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1part3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1part3.tcl -notrace

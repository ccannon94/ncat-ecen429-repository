...
## Switches
set_property PACKAGE_PIN V17 [get_ports y0]					
	set_property IOSTANDARD LVCMOS33 [get_ports y0]
set_property PACKAGE_PIN V16 [get_ports y1]					
	set_property IOSTANDARD LVCMOS33 [get_ports y1]
set_property PACKAGE_PIN W16 [get_ports x0]					
	set_property IOSTANDARD LVCMOS33 [get_ports x0]
set_property PACKAGE_PIN W17 [get_ports x1]					

...
HD_PWD='C:/Users/Chris/Documents/development/ncat-ecen429-repository/Lab3/Lab3Part3/Lab3Part3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_adder.tcl

...
HD_PWD='C:/Users/Chris/Documents/development/ncat-ecen429-repository/Lab3/Lab3Part3/Lab3Part3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_adder.tcl -notrace
